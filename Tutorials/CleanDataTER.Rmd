...
We will use example dataset which is available in the zip archive `NEAtl_FishTraitEnv_rawdata.zip`, available for download [here](https://raw.githubusercontent.com/rfrelat/TraitEnvironment/master/Data/NEAtl_FishTraitEnv_rawdata.zip). To run the following examples, extract the archive in a folder, and set the working directory of R to this folder.
...
Make sure the file [`Fish_trait.csv`](https://raw.githubusercontent.com/rfrelat/TraitEnvironment/master/Data/Fish_trait.csv) is in your working directory, then load it in R.
...
Make sure the file [`Fish_Environment.csv`](https://raw.githubusercontent.com/rfrelat/TraitEnvironment/master/Data/Fish_Environment.csv) is in your working directory, then load it in R.
...
Make sure the file [`Fish_Abundance.csv`](https://raw.githubusercontent.com/rfrelat/TraitEnvironment/master/Data/Fish_Abundance.csv) is in your working directory, then load it in R.
