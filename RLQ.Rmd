...
The example dataset is available as the Rdata file `NEAtl_FishTraitEnv.Rdata`, available for download [here](https://github.com/rfrelat/TraitEnvironment/raw/main/NEAtl_FishTraitEnv.Rdata) and the script can be found [here](https://github.com/rfrelat/TraitEnvironment/raw/main/RLQ_FishTraitEnv.R)
