...
## 4.3 Plot species-environment relationships
```{r, fig.align = "center"}
...
## 4.3 Plot trait-environment relationships
```{r, fig.align = "center"}
...
plotVariancePartitioning(m, VP, viridis(8)) #ignore random effect NA since we havn't specified a random effect 
```


## 4.5 Trait specifc metrics
...
## 4.5 Trait-enviornment relationships
...
## 4.6 Species co-occurrance patterns at random effect level 
